...
public class BSTree {
    ...
    /**
     * SEarch by Name : Check 3 case : 1: p is null , tree is empty => return
     * null 2: p = search => return p 3: p > search =>return and continue
     * search(left) else => search(right) until p = search and return.
     *
     */
    ...
    void balance(ArrayList<Person> t, Node p) {
        if (p == null) {
            return;
        }
        balance(t, p.left);
